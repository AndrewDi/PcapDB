...
public enum  DrdaCodePointType {
    ...
    static {
        ...
        DrdaCodePointType[] drdaCodePointTypes = DrdaCodePointType.values();
        for (DrdaCodePointType drdaCodePointType : drdaCodePointTypes) {
            hashMap.put(drdaCodePointType.value(),drdaCodePointType);
        }
    }
